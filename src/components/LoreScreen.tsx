...
const LORE_PAGES = [
  ...
  {
    title: '当今天下',
    text: '正道以天玄宗为首，据守东方灵脉，门下弟子数万。苍穹阁盘踞北方，与天玄宗分庭抗礼，两宗明争暗斗数百年。\n\n青莲剑宗隐于西山，以剑道闻名，弟子皆佩长剑，冷峻寡言。药谷居于南岭，世代炼丹，丹师辈出。归一寺坐落中原，高僧讲禅，以修心为本。\n\n魔道六宗蛰伏暗处，伺机而动。每逢正道内乱，魔修便趁虚而入。万妖殿化形白狐使者曾递和书，是战是和，众说纷纭。\n\n散修游走于宗门夹缝之中，或逍遥自在，或朝不保夕。\n\n而你，不过是芸芸众生中的一名少年。灵根初显，仙途在即。',
  },
  {
    title: '仙途在即',
    text: '十六岁这年，你体内的灵根终于觉醒。\n\n天玄宗百年一度的收徒盛会就在眼前。数百名少年才俊齐聚山门，执事长老目光如炬，逐一审视众人资质。\n\n你的灵根品质如何？是万中无一的天灵根，还是参差不齐的多灵根？是坦诚展露以求入门，还是虚夸资质图谋内门？亦或——拒绝宗门束缚，独行于天地之间？\n\n是飞升成仙，还是堕魔陨落？是成为神仙眷侣，还是逍遥散修？\n\n一切取决于你的选择。\n\n每一次抉择皆关机缘，每一步修行皆是天命。',
  },
]
